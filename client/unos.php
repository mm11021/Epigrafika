...
<div class="container" ng-controller='unosController' ng-cloak>
	...
	<div class="fieldset_border">
		<fieldset>
			...
			<div class="row form-group" ng-show="lokalizovan">
				...
				<div class="col-sm-3">
					<select name="provincija" id="provincija" class="form-control" ng-model="provincija" ng-required="lokalizovano">
				...
				<div class="col-sm-3 clirfix">
                    ...
                    <input id="mestoNalaska" class="form-control" type="text" name="mestoNalaska" ng-model="mestoNalaska" />
	...
	<div class="fieldset_border">
		...
		<div class="row form-group">
				...
				<div class="col-sm-4">
					...
					<span class="text-transparent" ng-class="{textred:formUnos.trenutnaLokacijaZnamenitosti.$dirty && (formUnos.trenutnaLokacijaZnamenitosti.$error.required || formUnos.trenutnaLokacijaZnamenitosti.$error.pattern)}">
				...
				<div class="col-sm-4">
                    ...
                    <input type="text" id="pleme" class="form-control" name="pleme" ng-model="pleme"/>
	...
	<div class="row">
		<div class="col-sm-4 col-sm-offset-2">
			<button type="button" class="btn btn-success btn-block" ng-class="{'disabled':!formUnos.$valid}" ng-click="posalji_podatke()" ng-enabled='formUnos.$valid'> {{tr.unesi_podatke}}  </button>
		</div>
		<div class="col-sm-4 ">
