...
<div class="container" ng-controller="adminZnamenitosti" ng-init="init();">
	...
	<div class="fieldset_border">
		<fieldset>
			...
			<div class="row form-group">
				...
				<div class="col-sm-9">
					<textarea  class="form-control textarea_unos" rows="3" id="natpis" ng-model="single.natpis" name="natpis" ng-required='true' /> </textarea>
	...
	<div class="fieldset_border">
		<fieldset>
			...
			<div class="row form-group" ng-show="single.lokalizovano">
				...
				<div class="col-sm-3">
					<!--izmena 15.novembar <select id="grad" class="form-control" name="grad" ng-model="single.gradNalaska" ng-required="single.lokalizovano">-->
                    <select id="grad" class="form-control" name="grad" ng-model="single.gradNalaska">
				...
				<div class="col-sm-3 clirfix">
					<input id="mestoNalaska" class="form-control" type="text" name="mestoNalaska" ng-model="single.mestoNalaska" ng-pattern="/^[a-zA-Z ]+$/"/>
	...
	<div class="fieldset_border">
		...
		<div class="row form-group">
				...
				<div class="col-sm-4">
					<input type="text" id="pleme" class="form-control" name="pleme" ng-model="single.plemeNaziv" ng-pattern="/^[a-zA-Z ]+$/"/>
	...
	<div class="fieldset_border">
		<fieldset>
			...
			<div class="row form-group">
				...
				<div class="col-sm-8">
					<textarea  rows="2" id="komentar" class="form-control textarea_unos" name="komentar" ng-model="single.komentar"/> </textarea>
					 <!--
					 az: korekcija 28. septembar 2016.
	...
	<div class="fieldset_border">
		<fieldset>
			...
			<div class="row form-group">
				<label for="natpis" class="col-sm-2 control-label">{{tr.natpis}}  <span style="color:red">*</span>:</label>
				<div class="col-sm-9">
					<textarea  class="form-control textarea_unos" rows="3" id="natpis" ng-model="natpis" name="natpis" ng-required='true' /> </textarea>
					<span class="text-transparent" ng-class="{textred:formUnos.natpis.$dirty && formUnos.natpis.$error.required}">
						{{tr.obavezno_polje}}
					</span>
				</div>
	...
	<div class="fieldset_border">
		<fieldset>
			...
			<div class="row form-group">
				<label for="komentar" class="col-sm-2 control-label">{{tr.komentar}}:</label>
				<div class="col-sm-8">
					<textarea  rows="2" id="komentar" class="form-control textarea_unos" name="komentar" ng-model="komentar" /> </textarea>
					 <!--
					 korekcija 28.septembra 2016.
					 <span class="text-transparent" ng-class="{textred: formUnos.komentar.$error.pattern && formUnos.komentar.$dirty}">
					{{tr.format_error_slova_cifre_tacka}}
					</span>
					-->
