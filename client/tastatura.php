...
<script type="text/javascript" src="static/scripts/fireEvent.js"></script>
<div style="position:sticky;top:0;z-index:1;background-color:inherit;width:auto;">
	<div style="display: table; margin: 0 auto;">
		<img class="keyboard" style="margin:auto;" src="static/img/keyboard.png" alt="Tastatura" onclick="prikaziTastaturu()"/>
	</div>
	<div id="ABCD" style="display: table; margin: 0 auto;">
	</div>
